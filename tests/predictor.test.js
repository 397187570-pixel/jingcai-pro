...
console.log('\n💎 价值注检测测试 (符号已修正: 价值 = 国际概率 − 竞彩概率 > 0)');
test('竞彩赔率优于国际(国际更看好主胜)时返回价值注', () => {
  // 国际主胜 1.80(概率高) vs 竞彩主胜 2.20(概率低/赔率更长) → 竞彩主胜更优, 价值 +9pp
  const bets = findValueBets(
    { h: 2.20, d: 3.20, a: 3.10 },  // 竞彩 (主胜赔率更长)
    { h: 1.80, d: 3.50, a: 4.00 },  // 国际 (主胜赔率更短=更看好主胜)
    0.04
  );
